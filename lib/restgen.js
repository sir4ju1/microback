...
class RestGen {
  ...
  generate () {
    var self = this
    if (this.model) {
      !this.find && this.createRoute('get', `/${this.pluralizedPath}`, 'modelFind')
      !this.findOne && this.createRoute('get', `/${this.path}/:id`, 'modelFindOne')
      !this.create && this.createRoute('post', `/${this.pluralizedPath}`, 'modelCreate', body)
      !this.update && this.createRoute('patch', `/${this.pluralizedPath}`, 'modelUpdate', body)
      !this.remove && this.createRoute('delete', `/${this.path}/:id`, 'modelRemove')
    }
